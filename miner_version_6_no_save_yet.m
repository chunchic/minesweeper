function miner_version_6_no_save_yet
...
%     function save_game(~,~)
%         directory_struct = dir;
%         directory_cell = struct2cell(directory_struct);
%         find_save_game_file = 0;
%         for i = 1:size(directory_cell,1)
%             if strcmp('save_minesweeper.txt',directory_cell(1,i))
%                 find_save_game_file = 1;
%             end
%         end
%         if ~find_save_game_file
%             % create
%         end
%         % save
%     end
...
%     function number_check(hObject,event)
%         number = str2num(event.Key);
%         if ~isnumeric(number) || isempty(number)   
%             hObject.String = '';
%             return % CHECK!!! DIFFERENT RESULT WHEN HAVING A BREAKPOINT AND NOT
%         end
%         if number > 24 || number < 9
%             hObject.String = '';
%         end
%     end
